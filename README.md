...
```javascript
import extname from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-extname@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/utils-extname/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/utils-extname/actions/workflows/test.yml?query=branch:v0.2.2
